...
[Image format]: #image-format "Specification - Image Format"
  [Version 1.x image format]: #type-1-image-format "Specification - Image Format - Version 1.x image format"
...
An [AppImage] which conforms to the Version 1.x image format:
