...
* **MUST** contain a `.DirIcon` file that follows the [Thumbnail Managing Standard Specification](https://specifications.freedesktop.org/thumbnail-spec/thumbnail-spec-latest.html#AEN144) format for large thumbnails (256x256).
